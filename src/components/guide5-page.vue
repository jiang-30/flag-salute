<template>
  <base-container :active="active" :index="index" :current="current">
    <img class="fill-img" src="@/assets/image/guide5.jpg" alt="guide">
    <template #item>
      <img class="guide-item animate__animated animate__zoomIn animate__delay-1s" :style="itemStyle[0]" src="@/assets/image/guide5_1.png" alt="guide1">
    </template>
  </base-container>
</template>
